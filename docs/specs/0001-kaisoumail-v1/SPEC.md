...
- 2026-04-16: Expanded verification-code detection to recognize traditional-Chinese security-code copy and bounded single-hyphen verification tokens (for cases like `WXN-DTJ`) while keeping host fragments, long identifiers, and promotional “use code” messages out of the verification path.
