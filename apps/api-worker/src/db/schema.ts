...
export const domains = sqliteTable(
  "domains",
  {
    ...
    subdomainDnsMode: text("subdomain_dns_mode").notNull().default("explicit"),
    wildcardDnsVerifiedAt: text("wildcard_dns_verified_at"),
    wildcardDnsLastError: text("wildcard_dns_last_error"),
