...
const demoDetails: MessageDetail[] = [
  {
    ...
    headers: [
      ...
      { key: "To", value: "build@alpha.example.com" },
  ...
  },
  {
    id: "msg_beta",
    mailboxId: "mbx_beta",
    mailboxAddress: "spec@beta.example.com",
    ...
    envelopeTo: "spec@beta.example.com",
    ...
    headers: [
      ...
      { key: "To", value: "spec@beta.example.com" },
